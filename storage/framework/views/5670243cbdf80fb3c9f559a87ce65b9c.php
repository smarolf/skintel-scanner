...
<body>
    ...
    <div class="content">
        <p>Hello <strong><?php echo e($submission->name); ?></strong>,</p>
            ...
            <?php if($submission->scanResults && $submission->scanResults->count() > 0): ?>
                ...
                <?php $__currentLoopData = $submission->scanResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="concern-item">
                        <strong><?php echo e(ucfirst(str_replace('_', ' ', $result->concern_type))); ?></strong>
                        <?php if($result->confidence_score): ?>
                            <span style="float: right; color: #14b8a6;"><?php echo e(number_format($result->confidence_score * 100, 1)); ?>% confidence</span>
                        <?php endif; ?>
                        <div style="clear: both; margin-top: 8px; font-size: 14px; color: #6b7280; line-height: 1.4;">
                            <?php switch($result->concern_type):
                                case ('redness'): ?>
        ...
        <div style="text-align: center;">
            <a href="<?php echo e($recommendationsUrl); ?>" class="cta-button">
    ...
    <div class="footer">
        ...
        <p>© <?php echo e(date('Y')); ?> SkinTel Scanner. All rights reserved.</p>
    </div>
</body>
</html>
<?php /**PATH /Users/orderonlinemac5/Labs/upwork/Schyler/skintel-scanner/resources/views/emails/customer-analysis-result.blade.php ENDPATH**/ ?>